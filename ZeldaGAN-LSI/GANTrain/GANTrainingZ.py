'''
python GANTrainingZ.py --nz 16 --seed 6
will train a GAN on all the training levels using a latent vector of size 16 using random seed 6
The model will be saved in the folder specified on line 58.
'''
...
index2strJsonZ = json.dumps(index2str)
f = open("index2strZ.json","w")
f.write(index2strJsonZ)
f.close()
